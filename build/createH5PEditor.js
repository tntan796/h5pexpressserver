 ...
 */
function createH5PEditor(config, localLibraryPath, localContentPath, localTemporaryPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const h5pEditor = new H5P.H5PEditor(kvCache, // this is a general-purpose cache
        config, undefined, cs, new H5P.fsImplementations.DirectoryTemporaryFileStorage(localTemporaryPath));
        return h5pEditor;
    });
}
